/**
 * Seed Serengeti Template
 * Populates the database with Serengeti Lodge template data
 */
...
async function seedSerengetiTemplate() {
  ...
  try {
    ...
    console.log('🌿 Seeding Serengeti Lodge Template...\n');
    ...
    const { data: template, error: templateError } = await supabase
      ...
      .insert({
        ...
        theme_config: {
          primaryColor: '#F97316', // Safari Orange
          secondaryColor: '#22c55e', // Safari Green
          fontFamily: 'Inter',
          fonts: {
            headingFont: 'Inter',
            bodyFont: 'Inter'
