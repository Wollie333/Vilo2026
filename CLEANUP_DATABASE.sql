-- ============================================================================
-- DATABASE CLEANUP SCRIPT - Remove All Transactional Data
-- ============================================================================
...
-- Chat & Communication
RAISE NOTICE 'Cleaning up chat and communication data...';
...
-- Reviews
RAISE NOTICE 'Cleaning up reviews...';
DELETE FROM public.review_responses WHERE 1=1;
DELETE FROM public.reviews WHERE 1=1;

-- Bookings & Related
RAISE NOTICE 'Cleaning up bookings and related data...';
...
-- Properties & Rooms
RAISE NOTICE 'Cleaning up properties and rooms...';
...
-- Promotions
RAISE NOTICE 'Cleaning up promotions...';
...
-- Add-ons
RAISE NOTICE 'Cleaning up add-ons...';
DELETE FROM public.addons WHERE 1=1;

-- Customers & Wishlists
RAISE NOTICE 'Cleaning up customers and wishlists...';
DELETE FROM public.wishlist_items WHERE 1=1;
DELETE FROM public.customers WHERE 1=1;

-- Support Tickets
RAISE NOTICE 'Cleaning up support tickets...';
...
RAISE NOTICE 'Cleaning up companies...';
...
RAISE NOTICE 'Cleaning up user settings...';
...
RAISE NOTICE 'Cleaning up non-admin users...';
