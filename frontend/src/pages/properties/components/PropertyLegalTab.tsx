/**
 * PropertyLegalTab Component
 *
 * Legal documents management tab for property detail page.
 * Contains Terms & Conditions and Cancellation Policies subtabs.
 */

import React, { useState, useEffect } from 'react';
import { Card, Spinner, Alert } from '@/components/ui';
import { legalService } from '@/services';
import { TermsTab } from '@/pages/legal/components/TermsTab';
import { CancellationPoliciesTab } from '@/pages/legal/components/CancellationPoliciesTab';
...
// Valid views for subtab navigation
type LegalView = 'terms' | 'cancellation';
...
export const PropertyLegalTab: React.FC<PropertyLegalTabProps> = ({ propertyId }) => {
  ...
  const renderContent = () => {
    if (isLoadingPolicies && activeView === 'cancellation') {
      return (
    ...
    switch (activeView) {
      case 'terms':
        return <TermsTab propertyId={propertyId} />;
      case 'cancellation':
        return (
