/**
 * Migration 045: Add Refund Comments and Status History
 *
...
CREATE INDEX idx_refund_comments_refund ON refund_comments(refund_request_id);
CREATE INDEX idx_refund_comments_user ON refund_comments(user_id);
CREATE INDEX idx_refund_comments_created ON refund_comments(created_at DESC);
...
-- Indexes for performance
CREATE INDEX idx_refund_status_history_refund ON refund_status_history(refund_request_id);
CREATE INDEX idx_refund_status_history_changed_at ON refund_status_history(changed_at DESC);
CREATE INDEX idx_refund_status_history_changed_by ON refund_status_history(changed_by);
