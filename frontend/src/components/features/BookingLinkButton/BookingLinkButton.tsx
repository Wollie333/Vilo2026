  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`Booking Page - ${propertyName}`}
        size="sm"
      >
        <div className="space-y-3">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Choose how you'd like to access the booking page for {propertyName}
          </p>
          ...
          {/* URL Display */}
          <div className="mt-4 p-3 bg-gray-50 dark:bg-dark-sidebar rounded-lg">
