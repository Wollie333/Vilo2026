-- Migration: 118_seed_serengeti_simple.sql
-- Description: Seed Serengeti Lodge template data (simplified - no category)
-- Date: 2026-01-18
...
-- Insert the template (using EXISTING schema columns, category_id can be NULL)
