-- Migration: 119_seed_serengeti_minimal.sql
-- Description: Seed Serengeti Lodge template data (minimal columns only)
-- Date: 2026-01-18
...
DELETE FROM website_templates WHERE name = 'Serengeti Lodge';

-- Insert the template with ONLY the columns that definitely exist
INSERT INTO website_templates (name, description, is_active)
VALUES (
  'Serengeti Lodge',
...
BEGIN
  -- Get the template ID
  SELECT id INTO v_template_id FROM website_templates WHERE name = 'Serengeti Lodge';
  ...
  RAISE NOTICE '✓ Created 5 homepage sections';
  ...
  RAISE NOTICE '✓ Created 4 about page sections';
  ...
  RAISE NOTICE '✓ Created 2 accommodation page sections';
  ...
  RAISE NOTICE '✓ Created 3 contact page sections';
  ...
  RAISE NOTICE '✓ Created 2 blog page sections';
